...
@property(nonatomic, nullable) NSDictionary<NSString *, NSString *> *passedAdditionalHeaders;

@property(nonatomic, nullable) _GACURLSessionDataResponse *passedAPIResponse;
