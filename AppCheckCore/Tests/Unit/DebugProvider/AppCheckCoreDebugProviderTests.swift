...
class AppCheckCoreDebugProviderTests: XCTestCase {
    ...
    func testGetTokenSuccessSetsRegisteredFlag() async throws {
        ...
        let registeredKey = "\(kDebugTokenRegisteredUserDefaultsKey)_test-service_projects_test-project_apps_test-app"
    ...
    func testGetTokenPermanentFailureClearsRegisteredFlag() async throws {
        // 1. Stub API service.
        let expectedDebugToken = provider.currentDebugToken()
        let apiError = NSError(domain: "testGetTokenPermanentFailureClearsRegisteredFlag", code: -1, userInfo: nil)
        fakeAPIService.tokenResult = .failure(apiError)
    ...
    func testGetTokenNetworkFailureDoesNotClearRegisteredFlag() async throws {
        // 1. Stub API service.
        let expectedDebugToken = provider.currentDebugToken()
        let networkError = NSError(domain: AppCheckCoreErrorDomain, code: AppCheckCoreErrorCode.serverUnreachable.rawValue, userInfo: nil)
