...
protocol GACAppCheckDebugProviderAPIServiceProtocol: NSObjectProtocol {
...
class GACAppCheckDebugProviderAPIService: NSObject, GACAppCheckDebugProviderAPIServiceProtocol {
