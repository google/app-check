...
public let kAppCheckCoreMissingRecaptchaSDKMessage = "The reCAPTCHA Enterprise SDK is not linked. See https://firebase.google.com/docs/app-check/ios/recaptcha-enterprise-provider#prepare-environment"
...
public class AppCheckCoreErrorUtil: NSObject {
    ...
    @objc
    public static func apiError(with httpResponse: HTTPURLResponse, data: Data?) -> AppCheckCoreHTTPError {
    ...
    public static func missingRecaptchaSDKError() -> Error {
        return appCheckError(withCode: .unsupported, failureReason: kAppCheckCoreMissingRecaptchaSDKMessage, underlyingError: nil)
    }
