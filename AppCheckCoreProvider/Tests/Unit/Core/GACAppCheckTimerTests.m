...
@implementation GACAppCheckTimerTests

- (void)testTimerProvider {
  dispatch_queue_t queue =
      dispatch_queue_create("GACAppCheckTimerTests.testInit", DISPATCH_QUEUE_SERIAL);
...
- (void)testInit {
  ...
  XCTestExpectation *timerExpectation = [self expectationWithDescription:@"timer"];
  GACAppCheckTimer *timer = [[GACAppCheckTimer alloc]
