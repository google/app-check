...
- (void)testInitialRefreshWhenAutoRefreshAllowed {
  ...
  self.initialTokenRefreshResult = [[GACAppCheckTokenRefreshResult alloc] initWithStatusNever];
  ...
  refresher.tokenRefreshHandler = ^(GACAppCheckTokenRefreshCompletion _Nonnull completion) {
  ...
  __auto_type initialRefreshResult = [[GACAppCheckTokenRefreshResult alloc]
      ...
      dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)),
                     dispatch_get_main_queue(), ^{
                       __auto_type refreshFailure =
                           [[GACAppCheckTokenRefreshResult alloc] initWithStatusFailure];
...
- (void)testUpdateWithRefreshResultWhenAutoRefreshIsAllowed {
  ...
  __auto_type newRefreshResult = [[GACAppCheckTokenRefreshResult alloc]
